function  Density_Image=PALMplot_dynein(coords, coords2, suffix)
    ...
    sigma_precision = 1;  % nm, default localization precision if none provided    
    sigmaThresh = Inf;      % use this to filter out spots with large sigmas
    PALMPixelSize = 150;     % nm, output PALM image pixel size   
