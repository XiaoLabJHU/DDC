...
%This will split up images so that 


%Make sure you get rid of cut5 CHRIS!!!!!
...
save(['Split_',Condition],'LocalizationsFinal','Frame_Information','addonarray','Parameters_to_split','Came_from_image','TrueLocalizations','cut1array','cut2array','cut3array','Resolution')
end
